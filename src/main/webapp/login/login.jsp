        ...
        $(function () {
            $("#loginButtonId").click(function () {
                ...
                if(username&&password&&code){
                    ...
                    $("#error").html("<font color='red'>请输入完整信息</font>")
                }
            })
        })
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post"
                            ...
                            <div class="form-group">
                                <input style="width: 287px; padding-left:20px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" placeholder="请输入手机号..."
                                       minlength="2" style="width: 400px; padding-left:20px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                                       class="form-password form-control" id="form-phone" required>
                            </div>
                            <div class="form-group">
